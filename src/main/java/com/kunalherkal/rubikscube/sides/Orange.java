...
public final class Orange extends SideAdapter {
	...
	public void rotateAntiClockwise() {
		...
		cube.getYellow().getColors()[0] = cube.getBlue().getColors()[6];
		cube.getYellow().getColors()[1] = cube.getBlue().getColors()[3];
		cube.getYellow().getColors()[2] = cube.getBlue().getColors()[0];
		
		cube.getBlue().getColors()[0] = cube.getWhite().getColors()[6];
		cube.getBlue().getColors()[3] = cube.getWhite().getColors()[7];
		cube.getBlue().getColors()[6] = cube.getWhite().getColors()[8];
		
		cube.getWhite().getColors()[6] = cube.getGreen().getColors()[8];
		cube.getWhite().getColors()[7] = cube.getGreen().getColors()[5];
		cube.getWhite().getColors()[8] = cube.getGreen().getColors()[2];

		cube.getGreen().getColors()[2] = tempSideColors[0];
		cube.getGreen().getColors()[5]= tempSideColors[1];
		cube.getGreen().getColors()[8] = tempSideColors[2];
	}
