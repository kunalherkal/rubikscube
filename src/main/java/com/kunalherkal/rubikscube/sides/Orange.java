...
public final class Orange extends SideAdapter {
	...
	public void rotateClockwise(Cube cube) {
		...
		cube.getBlue().getColors()[6] = cube.getYellow().getColors()[2];
		cube.getBlue().getColors()[3] = cube.getYellow().getColors()[5];
		cube.getBlue().getColors()[0] = cube.getYellow().getColors()[8];

		cube.getYellow().getColors()[2] = cube.getGreen().getColors()[6];
		cube.getYellow().getColors()[5] = cube.getGreen().getColors()[3];
		cube.getYellow().getColors()[8] = cube.getGreen().getColors()[0];

		cube.getGreen().getColors()[6] = cube.getWhite().getColors()[6];
		cube.getGreen().getColors()[3] = cube.getWhite().getColors()[3];
		cube.getGreen().getColors()[0] = cube.getWhite().getColors()[0];

		cube.getWhite().getColors()[0] = tempSideColors[2];
		cube.getWhite().getColors()[3] = tempSideColors[1];
		cube.getWhite().getColors()[6] = tempSideColors[0];
