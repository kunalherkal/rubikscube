...
public final class WhiteCrossOnYellowSideTest3 {
	Cube cube;
	...
	public void setUp() {
		...
		cube.getWhite().setTileColor(3, Color.RED);
		cube.getWhite().setTileColor(4, Color.WHITE);
		cube.getWhite().setTileColor(5, Color.ORANGE);
		cube.getWhite().setTileColor(6, Color.ORANGE);
		cube.getWhite().setTileColor(7, Color.GREEN);
		...
		cube.getRed().setTileColor(5, Color.RED);
		cube.getRed().setTileColor(6, Color.GREEN);
		cube.getRed().setTileColor(7, Color.WHITE);
		cube.getRed().setTileColor(8, Color.RED);

		cube.getYellow().setTileColor(0, Color.RED);
		...
		cube.getGreen().setTileColor(7, Color.ORANGE);
