...
public final class WhiteCrossOnYellowSideTest6 {
	Cube cube;
	...
	public void setUp() {
		...
		cube.getRed().setTileColor(0, Color.GREEN);
		...
		cube.getOrange().setTileColor(3, Color.BLUE);
		...
		cube.getBlue().setTileColor(7, Color.ORANGE);
		...
		cube.getYellow().setTileColor(3, Color.RED);
		...
		cube.getWhite().setTileColor(0, Color.WHITE);
		cube.getWhite().setTileColor(1, Color.BLUE);
		...
		cube.getWhite().setTileColor(6, Color.RED);
		cube.getWhite().setTileColor(7, Color.GREEN);
		cube.getWhite().setTileColor(8, Color.ORANGE);
