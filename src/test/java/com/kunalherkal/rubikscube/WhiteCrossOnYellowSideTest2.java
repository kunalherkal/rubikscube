...
public final class WhiteCrossOnYellowSideTest2 {
	Cube cube;
	...
	public void setUp() {
		...
		cube.getWhite().setTileColor(2, Color.RED);
		cube.getWhite().setTileColor(3, Color.BLUE);
		cube.getWhite().setTileColor(5, Color.BLUE);
		cube.getWhite().setTileColor(6, Color.ORANGE);
		...
		cube.getRed().setTileColor(5, Color.YELLOW);
		cube.getRed().setTileColor(6, Color.RED);
		cube.getRed().setTileColor(7, Color.WHITE);
		cube.getRed().setTileColor(8, Color.ORANGE);

		cube.getYellow().setTileColor(0, Color.BLUE);
		cube.getYellow().setTileColor(1, Color.BLUE);
		cube.getYellow().setTileColor(2, Color.RED);
		cube.getYellow().setTileColor(3, Color.GREEN);
		cube.getYellow().setTileColor(4, Color.YELLOW);
		cube.getYellow().setTileColor(5, Color.RED);
		...
		cube.getOrange().setTileColor(1, Color.GREEN);
		cube.getOrange().setTileColor(2, Color.BLUE);
		...
		cube.getOrange().setTileColor(6, Color.ORANGE);
		cube.getOrange().setTileColor(7, Color.WHITE);
		cube.getOrange().setTileColor(8, Color.YELLOW);

		cube.getBlue().setTileColor(0, Color.GREEN);
		...
		cube.getBlue().setTileColor(5, Color.WHITE);
		cube.getBlue().setTileColor(6, Color.YELLOW);
		cube.getBlue().setTileColor(7, Color.BLUE);
		cube.getBlue().setTileColor(8, Color.WHITE);

		cube.getGreen().setTileColor(0, Color.GREEN);
		cube.getGreen().setTileColor(1, Color.GREEN);
		cube.getGreen().setTileColor(2, Color.YELLOW);
		cube.getGreen().setTileColor(3, Color.RED);
		cube.getGreen().setTileColor(4, Color.GREEN);
		cube.getGreen().setTileColor(5, Color.ORANGE);
		cube.getGreen().setTileColor(6, Color.YELLOW);
		cube.getGreen().setTileColor(7, Color.YELLOW);
		cube.getGreen().setTileColor(8, Color.GREEN);
