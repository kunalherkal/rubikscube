...
public final class WhiteCrossTest {
	...
	public void setUp() {
		...
		cube.getWhite().setTileColor(3, Color.GREEN);
		...
		cube.getRed().setTileColor(1, Color.YELLOW);
		cube.getRed().setTileColor(2, Color.BLUE);
		...
		cube.getRed().setTileColor(8, Color.YELLOW);
		...
		cube.getYellow().setTileColor(8, Color.RED);
		...
		cube.getOrange().setTileColor(6, Color.WHITE);
		...
		cube.getBlue().setTileColor(6, Color.RED);
		...
		cube.getGreen().setTileColor(5, Color.WHITE);
		cube.getGreen().setTileColor(6, Color.BLUE);
		cube.getGreen().setTileColor(7, Color.BLUE);
		cube.getGreen().setTileColor(8, Color.ORANGE);
